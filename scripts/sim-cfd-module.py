...
def read_sim_cfd_bernoulli(P1=None, v1=None, h1=None, P2=None, v2=None, h2=None, rho=1000.0, g=9.81):
    """
    ...
    if len(none_keys) != 1:
        return {"error": f"Exactly 1 unknown required (found {len(none_keys)} unknowns)"}
