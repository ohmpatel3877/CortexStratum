...
#  Phase 1: Compact
compact = _load("compact_module", "../engine/compact-module.py")
...
#  Phase 2: Mutation
mut = _load("mutation_module", "../engine/mutation-module.py")
...
#  Phase 3: Plumber
plumb = _load("plumber_module", "../engine/plumber-module.py")
...
#  Phase 4.4: Mechanics
mech = _load("mechanics_module", "../engine/simulation/sim-mechanics-module.py")
...
math_mod = _load("math_module", "../engine/simulation/sim-math-module.py")
...
#  Phase 5: Pedagogy
ped = _load("pedagogy_module", "../engine/pedagogy-module.py")
...
cons = _load("consolidation_module", "pipeline/consolidation-daemon.py")
...
if errors:
    ...
    print(
        f"ALL {total} TESTS PASSED — zero regressions across {len(os.listdir(SCRIPTS))} script modules"
    )
    sys.exit(0)
