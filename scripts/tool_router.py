...
TOOL_CATEGORIES = {
    ...
    "write_memory_consolidate": ("memory", ["merge", "dedup", "jaccard"]),
    ...
    "mutate_audit_undo": ("permissions", ["undo", "checkpoint"]),
    ...
    "mutate_commitment_verify": ("trace", ["commitment", "verify"]),
    ...
    "read_sensory_set_browser_type": (
        "web",
        ["browser", "switch", "firefox", "chromium"],
    ),
