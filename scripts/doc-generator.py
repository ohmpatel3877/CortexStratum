#!/usr/bin/env python3
"""
Doc Generator — Automatic API documentation for cortex-stratum.
...
class DocGenerator:
    """Generates documentation from cortex-stratum scripts and MCP tools."""
...
<title>cortex-stratum API Documentation</title>
<style>
...
<div class="layout">
  ...
  <div class="main">
    ...
    <div class="gen-info">Generated by doc-generator.py &mdash; cortex-stratum</div>
  </div>
</div>
<script>
function filterDocs(q) {{
  ...
  document.querySelectorAll('.module-section').forEach(s => {{
    ...
    def print_summary(self):
        print(f"\n{B}{'='*60}{N}")
        print(f"{BOLD}cortex-stratum Documentation Summary{N}")
        print(f"{B}{'='*60}{N}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="cortex-stratum Documentation Generator")
