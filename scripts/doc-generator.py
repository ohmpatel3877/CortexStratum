#!/usr/bin/env python3
"""
Doc Generator — Automatic API documentation for ai-memory-core.
...
class DocGenerator:
    """Generates documentation from ai-memory-core scripts and MCP tools."""
...
<title>ai-memory-core API Documentation</title>
<style>
...
<div class="layout">
  ...
  <div class="main">
    ...
    <div class="gen-info">Generated by doc-generator.py &mdash; ai-memory-core</div>
  </div>
</div>
<script>
function filterDocs(q) {{
  ...
  document.querySelectorAll('.module-section').forEach(s => {{
    ...
    def print_summary(self):
        print(f"\n{B}{'='*60}{N}")
        print(f"{BOLD}ai-memory-core Documentation Summary{N}")
        print(f"{B}{'='*60}{N}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="ai-memory-core Documentation Generator")
