...
#  Depth levels 
DEPTHS = {
    1: {"label": "intuitive", "description": "Analogy-based, minimal jargon, big picture"},
    2: {"label": "basic", "description": "Core concepts with simple examples"},
    3: {"label": "intermediate", "description": "Formal definitions, standard notation"},
    4: {"label": "advanced", "description": "Full mathematical rigor, proofs, edge cases"},
    5: {"label": "expert", "description": "Research frontiers, open problems, trade-offs"}
}
...
def assess(queries=None, topic=""):
    ...
    advanced_terms = ["eigenvalue", "tensor", "convolution", "manifold", "homology",
                      "lagrangian", "hamiltonian", "functional analysis"]
...
def handle_tool_call(name, args):
    if name == "read_pedagogy_assess":
        ...
        return adapt(args.get("topic", ""), args.get("complexity"), args.get("format", "text"))
    elif name == "write_pedagogy_profile":
        return store_profile(args.get("depth"), args.get("topic", ""), args.get("feedback_score"))
