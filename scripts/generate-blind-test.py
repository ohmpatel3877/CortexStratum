...
questions = [
    ...
    },
    {
        ...
        "options": ["Fill 5, pour to 3, empty 3, pour remaining 2 to 3, fill 5, pour to 3 (1 left), empty 3, pour 1 to 3, fill 5, pour to 3 (need 2) = 4 remaining", "This is impossible", "Fill 3, pour to 5, fill 3, pour to 5 (2 left in 3), empty 5, pour 2 to 5, fill 3, pour to 5 (need 2) = 1 left", "Fill 5, pour to 3, empty 3, pour remaining 2 to 3, fill 5, pour 1 to fill 3 = 4 left in 5"],
        "answer_idx": 3
    },
    {
        "id": "blind-3",
    ...
    },
    {
        ...
        "options": ["A=knight, B=knave", "A=knave, B=knight", "A=knight, B=knight", "A=knave, B=knave"],
        "answer_idx": 1
    },
    {
        "id": "blind-6",
    ...
    },
    {
        ...
        "options": ["The car broke down and he can't afford repairs", "He's playing Monopoly", "The hotel is his last asset and he's losing it", "None of the above"],
        "answer_idx": 1
    },
    {
        "id": "blind-8",
        ...
        "options": ["Flip switch 1, wait 5 min, turn off, flip switch 2, enter. If on = 2, if off and warm = 1, if off and cold = 3", "Flip all three and enter", "Flip switch 1, enter, check bulb, if off go back and flip 2", "This is impossible with one entry"],
        "answer_idx": 0
    },
    {
        "id": "blind-9",
...
print(f"Answers:    {os.path.join(BASE, 'blind-answers.enc')}  (XOR-masked, key=0x{0xAA:02x})")
print()
