...
class DAGStateManager:
    ...
    def __init__(self, dag_id: str, base_dir: str | None = None):
        """
    ...
    def read_state(self, node_id: str) -> dict | None:
        """
    ...
    def init_node_state(
        self, node_id: str, input_data: dict, temperature: float = 0.7
    ) -> dict:
        """
    ...
    def mark_completed(
        self, node_id: str, output: dict, duration_ms: float | None = None
    ) -> dict:
    ...
    def mark_failed(
        self, node_id: str, errors: list, duration_ms: float | None = None
    ) -> dict:
    ...
    def read_heartbeat(self, node_id: str) -> dict | None:
