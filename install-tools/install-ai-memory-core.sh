...
# ====================================================================
# Usage:
# bash <(curl -s https://raw.githubusercontent.com/ohmpatel3877/CortexStratum/main/plugin-tools/install.sh)
# or from local:
# bash plugin-tools/install-CortexStratum.sh
...
echo "╔══════════════════════════════════════════════════╗"
echo "║    CortexStratum — 1-Click Installer           ║"
echo "║    $PROJECT_DIR"
echo "╚══════════════════════════════════════════════════╝"
...
if [ ! -f .env ]; then
  echo "MEM0_PROJECT=CortexStratum" > .env
    ...
    cat > opencode.json << 'JSONEOF'
{
  ...
  "mcpServers": {
    "CortexStratum": {
      "name": "CortexStratum",
      "description": "115-tool MCP server: xTrace, DTrace, Skill Router, Verifier, Goal Registry, multi-module AI",
      "command": "python",
