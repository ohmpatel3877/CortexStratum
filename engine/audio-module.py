...
def music_theory(args: dict) -> dict:
    ...
    intervals_named = [
        INTERVAL_NAMES.get(st % 12, f"{st % 12} semitones") for st in semitones
    ]
...
def convert_guide(args: dict) -> dict:
    ...
    if target_map:
        ...
        command = (
            f"ffmpeg -i input.{source_fmt} -codec:a lib{target_fmt} output.{target_fmt}"
        )
...
def generate_tone(args: dict) -> dict:
    ...
    if waveform_type not in WAVEFORM_GENERATORS:
        return {
            "status": "error",
            "error": f"Unknown waveform: {waveform_type}. Choose: sine, square, sawtooth, triangle",
        }
...
AUDIO_TOOLS: list[dict[str, Any]] = [
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "data_base64": {
                    "type": "string",
                    "description": "Base64-encoded WAV data (alternative to file_path)",
                },
                "format": {
                    "type": "string",
                    "default": "wav",
                    "description": "Audio format hint (wav)",
                },
            },
            "required": [],
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "data_base64": {
                    "type": "string",
                    "description": "Base64-encoded WAV data",
                },
                "width": {
                    "type": "integer",
                    "default": 80,
                    "description": "Character width of the waveform",
                },
                "height": {
                    "type": "integer",
                    "default": 20,
                    "description": "Character height of the waveform",
                },
            },
            "required": [],
        },
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "num_bands": {
                    "type": "integer",
                    "default": 7,
                    "description": "Number of frequency bands to analyze (max 7)",
                },
            },
            "required": [],
        },
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "duration_seconds": {
                    "type": "number",
                    "default": 0,
                    "description": "Duration of speech in seconds (for WPM calculation)",
                },
            },
            "required": ["transcript"],
        },
        ...
        "inputSchema": {
            ...
            "properties": {
                "source_format": {
                    "type": "string",
                    "default": "wav",
                    "description": "Source format (wav, mp3, flac, etc.)",
                },
                "target_format": {
                    "type": "string",
                    "default": "mp3",
        ...
        "inputSchema": {
            ...
            "properties": {
                "frequency": {
                    "type": "number",
                    "default": 440,
                    "description": "Frequency in Hz (default A4=440)",
                },
                "duration_seconds": {
                    "type": "number",
                    "default": 1,
